if (!inimigos_summonados && instance_number(obj_larva_pai) == 0) {
    ...
    instance_create_layer(1032, 499, "Ins_Entidades", obj_lesma_1);
    instance_create_layer(1111, 500, "Ins_Entidades", obj_lesma_1);
    instance_create_layer(1199, 498, "Ins_Entidades", obj_lesma_1);
    ...
    var novo_controlador = instance_create_layer(974, 440, "Controladores", obj_controlador_B_4);
