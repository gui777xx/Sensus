if (!inimigos_summonados && instance_number(obj_larva_pai) == 0) {
    ...
    instance_create_layer(1100, 711, "Ins_Entidades", obj_besouro_1);
    instance_create_layer(1164, 690, "Ins_Entidades", obj_larva_1);
    instance_create_layer(1155, 720, "Ins_Entidades", obj_lesma_1);
    ...
    var novo_controlador = instance_create_layer(1034, 631, "Controladores", obj_controlador_B_5);
